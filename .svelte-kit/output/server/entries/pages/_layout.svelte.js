import { D as copy_payload, E as assign_payload, F as bind_props, C as pop, z as push, G as ensure_array_like, I as attr_class, J as store_get, K as attr, M as unsubscribe_stores, N as head } from "../../chunks/index.js";
...
function NavBar($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    ...
    $$payload2.out += `<div class="navbar-row svelte-17duepy"><div class="navbar svelte-17duepy"><!--[-->`;
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let block = each_array[$$index];
      $$payload2.out += `<div${attr_class("block svelte-17duepy", void 0, {
        "black": block.isBlack,
        "blue": block.isBlue,
        "red": block.isRed
      })}></div>`;
    }
    $$payload2.out += `<!--]--></div> <div class="label-box svelte-17duepy">Create</div> <div class="navbar alt-theme svelte-17duepy"><!--[-->`;
    ...
    $$payload2.out += `<!--]--></div> <div class="label-box svelte-17duepy">List</div> <div class="label-box svelte-17duepy">Gallery</div> <div class="navbar alt-theme-2 svelte-17duepy"><!--[-->`;
    ...
    $$payload2.out += `<!--]--></div> <div class="menu-bar svelte-17duepy">`;
    if (store_get($$store_subs ??= {}, "$user", user)) {
      $$payload2.out += "<!--[-->";
      $$payload2.out += `<div class="menu-block logout svelte-17duepy" title="Logout"><svg class="icon svelte-17duepy" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg></div> <div class="menu-block avatar svelte-17duepy"><img${attr("src", store_get($$store_subs ??= {}, "$avatarUrl", avatarUrl))} alt="avatar" class="avatar-image svelte-17duepy"></div>`;
    } else {
      $$payload2.out += "<!--[!-->";
      $$payload2.out += `<div class="menu-block login svelte-17duepy" title="Login"><svg class="icon svelte-17duepy" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg></div>`;
    }
    $$payload2.out += `<!--]--> <div class="menu-block about svelte-17duepy" title="About"><svg class="icon svelte-17duepy" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg></div></div></div> `;
    {
      $$payload2.out += "<!--[!-->";
    }
    $$payload2.out += `<!--]-->`;
